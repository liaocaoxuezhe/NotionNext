...
const BLOG = {
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://illegiuploadpics.oss-cn-beijing.aliyuncs.com/RSMJ174_young_illustration_minimalist_fun_intelligent_scholar_a_a8d2bb31-f5cc-4947-953e-ebc7f0a8ce84.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  // 作废配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || 'https://illegiuploadpics.oss-cn-beijing.aliyuncs.com/RSMJ174_young_illustration_minimalist_fun_intelligent_scholar_a_a8d2bb31-f5cc-4947-953e-ebc7f0a8ce84.png', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
